...
<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous"><?php echo $this->tag->linkTo(array("maestros/users", "Ir Atrás")) ?></li>
        </ul>
    </nav>
</div>
...
<div class="form-group">
   ...
   <?php echo $this->tag->selectStatic(array("banned", array('N'=>'No', 'Y'=>'Sí'), "class" => "form-control", "id" => "fieldBanned")) ?>
 </div>

<div class="form-group">
    <label for="fieldSuspended">Suspendido</label>
   <?php echo $this->tag->selectStatic(array("suspended", array('N'=>'No', 'Y'=>'Sí'), "class" => "form-control", "id" => "fieldSuspended")) ?>
 </div>
