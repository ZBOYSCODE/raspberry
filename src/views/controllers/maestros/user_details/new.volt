...
<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous"><?php echo $this->tag->linkTo(array("maestros/userdetails", "Ir Atrás")) ?></li>
        </ul>
    </nav>
</div>
...
<div class="form-group">
    <label for="fieldComments">Comentarios</label>
   <?php echo $this->tag->textArea(array("comments", "cols" => 30, "rows" => 4, "class" => "form-control", "id" => "fieldComments")) ?>
 </div>
